let s:cc = {}
let s:cc.bg_main          = #{ gui: '#101035', cterm: 234 }
let s:cc.bg0              = #{ gui: '#0a0a2a', cterm: 233 }
let s:cc.bg1              = #{ gui: '#101040', cterm: 17 }
let s:cc.bg2              = #{ gui: '#181838', cterm: 235 }
let s:cc.bg3              = #{ gui: '#202040', cterm: 236 }
let s:cc.bg4              = #{ gui: '#303050', cterm: 237 }
let s:cc.bg5              = #{ gui: '#404060', cterm: 60 }
...
function! colorscheme_midnight_common#midnightindigo_colors#get()
  return s:cc
endfunction
