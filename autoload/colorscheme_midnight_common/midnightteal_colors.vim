let s:cc = {}
let s:cc.bg_main          = #{ gui: '#041628', cterm: 234 }
let s:cc.bg0              = #{ gui: '#031220', cterm: 233 }
let s:cc.bg1              = #{ gui: '#041c35', cterm: 234 }
let s:cc.bg2              = #{ gui: '#0a1c2d', cterm: 235 }
let s:cc.bg3              = #{ gui: '#0f2235', cterm: 236 }
let s:cc.bg4              = #{ gui: '#1b2f44', cterm: 237 }
let s:cc.bg5              = #{ gui: '#263d53', cterm: 237 }
...
function! colorscheme_midnight_common#midnightteal_colors#get()
  return s:cc
endfunction
