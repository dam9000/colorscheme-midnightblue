let s:cc = {}
let s:cc.bg_main          = #{ gui: '#081a16', cterm: 234 }
let s:cc.bg0              = #{ gui: '#05130f', cterm: 233 }
let s:cc.bg1              = #{ gui: '#0a2720', cterm: 235 }
let s:cc.bg2              = #{ gui: '#0d1f1b', cterm: 235 }
let s:cc.bg3              = #{ gui: '#203631', cterm: 236 }
let s:cc.bg4              = #{ gui: '#304540', cterm: 237 }
let s:cc.bg5              = #{ gui: '#405550', cterm: 23 }
...
function! colorscheme_midnight_common#midnightgreen_colors#get()
  return s:cc
endfunction
